...
! function(e, t) {
    ...
    var n = {
            ...
            isObject: function(e) {
                return "object" == (void 0 === e ? "undefined" : _typeof(e)) && null !== e && e.constructor && e.constructor === Object
            },
            extend: function() {
                for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    ...
    var h = {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== s) {
                    ...
                    for (var C, M = e.slidesPerColumn, P = S / M, z = Math.floor(h / e.slidesPerColumn), k = 0; k < h; k += 1) {
                        T = 0;
                        var L = d.eq(k);
                        if (e.slidesPerColumn > 1) {
                            ...
                            if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                                ...
                                $ = (I = A - (D = Math.floor(A / e.slidesPerColumn)) * e.slidesPerGroup + O * e.slidesPerGroup) + D * S / M, L.css({
                        ...
                        if ("none" !== L.css("display")) {
                            if ("auto" === e.slidesPerView) {
                                ...
                                if (G && (L[0].style.transform = "none"), N && (L[0].style.webkitTransform = "none"), e.roundLengths) T = this.isHorizontal() ? L.outerWidth(!0) : L.outerHeight(!0);
                                    ...
                                    var B = parseFloat(H.getPropertyValue("width")),
                                        ...
                                        q = parseFloat(H.getPropertyValue("margin-right")),
                                        R = H.getPropertyValue("box-sizing");
                                    T = R && "border-box" === R ? B + Y + q : B + V + X + Y + q
                                } else {
                                    ...
                                    T = U && "border-box" === U ? F + _ + K : F + W + j + _ + K
                                }
                                G && (L[0].style.transform = G), N && (L[0].style.webkitTransform = N), e.roundLengths && (T = Math.floor(T))
                            } else T = (s - (e.slidesPerView - 1) * y) / e.slidesPerView, e.roundLengths && (T = Math.floor(T)), d[k] && (this.isHorizontal() ? d[k].style.width = T + "px" : d[k].style.height = T + "px");
                            d[k] && (d[k].swiperSlideSize = T), u.push(T), e.centeredSlides ? (w = w + T / 2 + x / 2 + y, 0 === x && 0 !== k && (w = w - s / 2 - y), 0 === k && (w = w - s / 2 - y), Math.abs(w) < .001 && (w = 0), e.roundLengths && (w = Math.floor(w)), E % e.slidesPerGroup == 0 && p.push(w), c.push(w)) : (e.roundLengths && (w = Math.floor(w)), E % e.slidesPerGroup == 0 && p.push(w), c.push(w), w = w + T + y), this.virtualSize += T + y, x = T, E += 1
                        }
                    }
                    if (this.virtualSize = Math.max(this.virtualSize, s) + m, a && r && ("slide" === e.effect || "coverflow" === e.effect) && i.css({
                        ...
                        for (var J = 0; J < p.length; J += 1) {
                            var Z = p[J];
                            e.roundLengths && (Z = Math.floor(Z)), p[J] < this.virtualSize + p[0] && C.push(Z)
                        }
                        p = C
                    }
                    if (!e.centeredSlides) {
                        ...
                        for (var Q = 0; Q < p.length; Q += 1) {
                            var ee = p[Q];
                            e.roundLengths && (ee = Math.floor(ee)), p[Q] <= this.virtualSize - s && C.push(ee)
                        }
        ...
        u = {
            ...
            loopFix: function() {
                ...
                i < a ? (e = s.length - 3 * a + i, e += a, this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d)) : ("auto" === t.slidesPerView && i >= 2 * a || i >= s.length - a) && (e = -s.length + i + a, e += a, this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d)), this.allowSlidePrev = r, this.allowSlideNext = n
            },
        ...
        f = {
            appendSlide: function(e) {
                var t = this.$wrapperEl,
                    i = this.params;
                if (i.loop && this.loopDestroy(), "object" == (void 0 === e ? "undefined" : _typeof(e)) && "length" in e)
            ...
            prependSlide: function(e) {
                ...
                var a = s + 1;
                if ("object" == (void 0 === e ? "undefined" : _typeof(e)) && "length" in e) {
            ...
            addSlide: function(e, t) {
                ...
                if (e <= 0) this.prependSlide(t);
                    ...
                    if ("object" == (void 0 === t ? "undefined" : _typeof(t)) && "length" in t) {
            ...
            if (!i.isTouchEvent || "mousemove" !== l.type) {
                ...
                if (i.allowTouchCallbacks && this.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)) < this.params.threshold))
                        if (void 0 === i.isScrolling && (this.isHorizontal() && r.currentY === r.startY || this.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : c * c + u * u >= 25 && (p = 180 * Math.atan2(Math.abs(u), Math.abs(c)) / Math.PI, i.isScrolling = this.isHorizontal() ? p > a.touchAngle : 90 - p > a.touchAngle)), i.isScrolling && this.emit("touchMoveOpposite", l), void 0 === i.startMoving && (r.currentX === r.startX && r.currentY === r.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;
        ...
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, p = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, !s.cssMode)
            if (s.freeMode) {
                ...
                if (s.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate()) s.freeModeMomentumBounce ? (w + t.maxTranslate() < -T && (w = t.maxTranslate() - T), x = t.maxTranslate(), S = !0, i.allowMomentumBounce = !0) : w = t.maxTranslate(), s.loop && s.centeredSlides && (E = !0);
                    else if (w > t.minTranslate()) s.freeModeMomentumBounce ? (w - t.minTranslate() > T && (w = t.minTranslate() + T), x = t.minTranslate(), S = !0, i.allowMomentumBounce = !0) : w = t.minTranslate(), s.loop && s.centeredSlides && (E = !0);
                    ...
                    s.freeModeMomentumBounce && S ? (t.updateProgress(x), t.setTransition(b), t.setTranslate(w), t.transitionStart(!0, t.swipeDirection), t.animating = !0, o.transitionEnd(function() {
                ...
                if (u > s.longSwipesMs) {
                    ...
                    "next" === t.swipeDirection && (L >= s.longSwipesRatio ? t.slideTo(P + s.slidesPerGroup) : t.slideTo(P)), "prev" === t.swipeDirection && (L > 1 - s.longSwipesRatio ? t.slideTo(P + s.slidesPerGroup) : t.slideTo(P))
                } else {
    ...
    var x, E = {
            ...
            events: {
                attachEvents: function() {
                    var t = this.params,
                        ...
                        s = this.el,
                        a = this.wrapperEl;
                    this.onTouchStart = g.bind(this), this.onTouchMove = b.bind(this), this.onTouchEnd = y.bind(this), t.cssMode && (this.onScroll = function() {
                        var e = this.wrapperEl;
                    ...
                    if (o.touch || !o.pointerEvents && !o.prefixedPointerEvents) {
                        ...
                        }(t.simulateTouch && !m.ios && !m.android || t.simulateTouch && !o.touch && m.ios) && (s.addEventListener("mousedown", this.onTouchStart, !1), e.addEventListener("mousemove", this.onTouchMove, r), e.addEventListener("mouseup", this.onTouchEnd, !1))
                    ...
                    (t.preventClicks || t.preventClicksPropagation) && s.addEventListener("click", this.onClick, !0), t.cssMode && a.addEventListener("scroll", this.onScroll), this.on(m.ios || m.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", w, !0)
                },
                detachEvents: function() {
                    ...
                    if (o.touch || !o.pointerEvents && !o.prefixedPointerEvents) {
                        ...
                        }(t.simulateTouch && !m.ios && !m.android || t.simulateTouch && !o.touch && m.ios) && (s.removeEventListener("mousedown", this.onTouchStart, !1), e.removeEventListener("mousemove", this.onTouchMove, r), e.removeEventListener("mouseup", this.onTouchEnd, !1))
                    ...
                    (t.preventClicks || t.preventClicksPropagation) && s.removeEventListener("click", this.onClick, !0), t.cssMode && a.removeEventListener("scroll", this.onScroll), this.off(m.ios || m.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", w)
                }
            },
            breakpoints: {
            ...
            classes: {
                addClasses: function() {
                    var e = this.classNames,
                        ...
                        s = this.$el,
                        a = [];
                    a.push("initialized"), a.push(t.direction), t.freeMode && a.push("free-mode"), t.autoHeight && a.push("autoheight"), i && a.push("rtl"), t.slidesPerColumn > 1 && (a.push("multirow"), "column" === t.slidesPerColumnFill && a.push("multirow-column")), m.android && a.push("android"), m.ios && a.push("ios"), t.cssMode && a.push("css-mode"), a.forEach(function(i) {
        ...
        C = function(e) {
            function t() {
                ...
                1 === l.length && l[0].constructor && l[0].constructor === Object ? r = l[0] : (a = (i = l)[0], r = i[1]), r || (r = {}), r = n.extend({}, r), a && !r.el && (r.el = a), e.call(this, r), Object.keys(S).forEach(function(e) {
                ...
                void 0 === h.modules && (h.modules = {}), Object.keys(h.modules).forEach(function(e) {
                    ...
                    if (t.params) {
                        var i = Object.keys(t.params)[0],
                            s = t.params[i];
                        if ("object" != (void 0 === s ? "undefined" : _typeof(s)) || null === s) return;
                ...
                var p = n.extend({}, E);
                h.useModulesParams(p), h.params = n.extend({}, p, T, r), h.originalParams = n.extend({}, h.params), h.passedParams = n.extend({}, r), h.$ = s;
                var c = s(h.params.el);
                if (a = c[0]) {
                    if (c.length > 1) {
                        var u = [];
        ...
        D = {
            update: function(e) {
                ...
                if (n.extend(t.virtual, {
                    ...
                    }), p === x && c === E && !e) return t.slidesGrid !== v && S !== m && t.slides.css(g, S + "px"), void t.updateProgress();
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    ...
                    if ("fraction" === t.type && (r.find("." + t.currentClass).text(t.formatFractionCurrent(i + 1)), r.find("." + t.totalClass).text(t.formatFractionTotal(n))), "progressbar" === t.type) {
                        ...
                        var b = (i + 1) / n,
                            y = 1,
                            w = 1;
                        "horizontal" === g ? y = b : w = b, r.find("." + t.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + y + ") scaleY(" + w + ")").transition(this.params.speed)
                    }
        ...
        Y = {
            ...
            onTouchStart: function(e) {
                var t = this.zoom,
                    i = t.gesture,
                    s = t.image;
                i.$imageEl && 0 !== i.$imageEl.length && (s.isTouched || (m.android && e.preventDefault(), s.isTouched = !0, s.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, s.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY))
            },
            ...
            scrollToSlide: function(e, t, i) {
                if (t)
                    for (var s = 0, a = this.slides.length; s < a; s += 1) {
                        ...
                        if (W.slugify(r.attr("data-history")) === t && !r.hasClass(this.params.slideDuplicateClass)) {
                            var n = r.index();
                            this.slideTo(n, e, i)
                        }
        ...
        U = {
            setTranslate: function() {
                ...
                for (var u = 0; u < a.length; u += 1) {
                    ...
                    var E = "rotateX(" + (h ? 0 : -m) + "deg) rotateY(" + (h ? m : 0) + "deg) translate3d(" + y + "px, " + w + "px, " + x + "px)";
                    if (b <= 1 && b > -1 && (c = 90 * f + 90 * b, o && (c = 90 * -f - 90 * b)), v.transform(E), d.slideShadows) {
                        var S = h ? v.find(".swiper-slide-shadow-left") : v.find(".swiper-slide-shadow-top"),
                            T = h ? v.find(".swiper-slide-shadow-right") : v.find(".swiper-slide-shadow-bottom");
                        0 === S.length && (S = s('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>'), v.append(S)), 0 === T.length && (T = s('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>'), v.append(T)), S.length && (S[0].style.opacity = Math.max(-b, 0)), T.length && (T[0].style.opacity = Math.max(b, 0))
                    }
                }
                if (i.css({
                    ...
                    } var $ = z.isSafari || z.isUiWebView ? -l / 2 : 0;
            ...
            setTranslate: function() {
                for (var e = this.width, t = this.height, i = this.slides, a = this.$wrapperEl, r = this.slidesSizesGrid, n = this.params.coverflowEffect, l = this.isHorizontal(), d = this.translate, h = l ? e / 2 - d : t / 2 - d, p = l ? n.rotate : -n.rotate, c = n.depth, u = 0, v = i.length; u < v; u += 1) {
                    ...
                    if (f.transform(S), f[0].style.zIndex = 1 - Math.abs(Math.round(g)), n.slideShadows) {
                        ...
                        0 === T.length && (T = s('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>'), f.append(T)), 0 === C.length && (C = s('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>'), f.append(C)), T.length && (T[0].style.opacity = g > 0 ? g : 0), C.length && (C[0].style.opacity = -g > 0 ? -g : 0)
                    }
...
var initSwiperSlider = function() {
    var e = function() {
        var e = !0,
            t = !1,
            i = void 0;
        try {
            for (var s, a = window.swipeSlider[Symbol.iterator](); !(e = (s = a.next()).done); e = !0) {
                var r = s.value;
                if (r.syncSlide) {
                    var n = new Swiper("." + r.thumbElm, {
                ...
                r.wistiaID && Object.assign(r.options, {
                    on: {
                        slideChangeTransitionEnd: function(e) {
                            var t = this.slides[this.activeIndex],
                                i = Boolean(t.querySelector(".sl_video").dataset.autoplay);
                            this.slides[this.activeIndex].querySelectorAll(".wistia_embed").length > 0 && i ? (Wistia.api(this.slides[this.activeIndex].querySelector(".sl_video").dataset.videoid).play(), Wistia.api(this.slides[this.previousIndex].querySelector(".sl_video").dataset.videoid).pause()) : Wistia.api(this.slides[this.activeIndex].querySelector(".sl_video").dataset.videoid).pause()
                        }
                    }
                });
                new Swiper("." + r.mainElm, r.options);
                _q("." + r.mainElm).querySelector(".swiper-lazy-preloader.widget-loader-icon").classList.add("hidden"), r.thumbElm && _q("." + r.thumbElm).querySelector(".swiper-lazy-preloader.widget-loader-icon").classList.add("hidden")
            }
        } catch (e) {
            t = !0, i = e
        } finally {
...
window.addEventListener("load", function() {
    ...
    function() {
        function e(e) {
            var t = "";
            location.href.indexOf("?") && (t = location.href.substr(location.href.indexOf("?")));
            var i = t.match(new RegExp("[?&]" + e + "=([^&]*)(&?)", "i"));
            return i ? i[1] : null
        }! function() {
            if ("0" === e("ads")) {
                var t = ["advertorial", "Redaktionelle Anzeige", "Publicité", "Publirreportaje", "Publieditorial", "Publirreportagem", "广告", "Redazionale", "광고", "Mainosartikkeli", "Reklammeddelande", "Annonce", "Annonsetekst", "Advertorial", "記事体広告", "Bài viết quảng cáo"],
                    i = !1;
                Array.prototype.slice.call(_qAll(".wrapper *")).some(function(e) {
                    var s = !0,
                        a = !1,
                        r = void 0;
                    try {
                        for (var n, o = t[Symbol.iterator](); !(s = (n = o.next()).done); s = !0) {
                            var l = n.value;
                            if (e.innerHTML.trim().toLowerCase() === l.toLowerCase()) {
                                e.style.opacity = "0", e.style.height = "1px", e.style.width = "1px", e.style.pointerEvents = "none", i = !0, document.querySelector("body").classList.add("hidden-ads");
                                break
                            }
                        }
                    } catch (e) {
        ...
        function() {
            if ("0" === e("sm")) {
                var t = !0,
                    ...
                    s = void 0;
                try {
                    for (var a, r = document.querySelectorAll(".socialBtn")[Symbol.iterator](); !(t = (a = r.next()).done); t = !0) a.value.classList.add("hidden")
                } catch (e) {
                    i = !0, s = e
                } finally {
                    try {
                ...
                var n = !0,
                    ...
                    l = void 0;
                try {
                    for (var d, h = document.querySelectorAll(".socialBtn")[Symbol.iterator](); !(n = (d = h.next()).done); n = !0) d.value.classList.remove("hidden")
                } catch (e) {
                    o = !0, l = e
                } finally {
                    try {
        ...
        }(), "0" === e("testi") && -1 !== window.location.pathname.indexOf("index") && Array.prototype.slice.call(document.querySelectorAll(".average-rating, .rating-block, .list-rating, .comment-block")).forEach(function(e) {
            e.closest("section").classList.add("hidden")
        })
    }(),
    function() {
        function e() {
            var e = void 0,
                t = document.querySelector(".floating-bar"),
                i = window.pageYOffset,
                s = i + window.innerHeight,
                a = t.dataset.class.split(",").map(function(e) {
                    return e.trim()
                });
            a[0] && (e = function(e) {
                var t = [],
                ...
                try {
                    for (var r, n = e[Symbol.iterator](); !(i = (r = n.next()).done); i = !0) {
                        var o = r.value,
                            ...
                            p = void 0;
                        try {
                            for (var c, u = l[Symbol.iterator](); !(d = (c = u.next()).done); d = !0) {
                                var v = c.value;
                                if (v.offsetWidth || v.offsetHeight || v.getClientRects().length) {
            ...
            var r = void 0,
                n = void 0;
            t.dataset.ticktopelm ? (r = t.dataset.ticktopelm, n = i) : t.dataset.tickbottomelm && (r = t.dataset.tickbottomelm, n = s);
            var o = document.body.getBoundingClientRect(),
                l = document.querySelector(r).getBoundingClientRect();
            n >= l.top - o.top ? a[0] && function(e, t, i) {
                var s = !1,
                    a = !0,
                    r = !1,
                    n = void 0;
                ...
                return s
            }(i, s, e) ? t.classList.contains("floating-visible") && t.classList.remove("floating-visible") : t.classList.contains("floating-visible") || t.classList.add("floating-visible") : t.classList.contains("floating-visible") && t.classList.remove("floating-visible");
            l.top + l.height <= 0 ? t.classList.add("marked-elm") : t.classList.remove("marked-elm")
        }
        ...
        window.addEventListener("load", function() {
            if (window.siteSetting && siteSetting.webKey && siteSetting.CID) {
                if (function(t) {
                        ...
                        if (s) try {
                            var a = (s = JSON.parse(s)).camps.filter(function(e) {
                                return e[t]
                            });
                            if (a.length > 0) {
                                var r = new Date(a[0][t].timestamp),
                                    n = new Date,
                                    o = Math.abs(n - r) / 1e3,
                                    l = Math.floor(o / 60);
                                l > 1 && (i = !1)
                        ...
                        return i
                    }(siteSetting.webKey)) return;
                var t = "https://websales-api.tryemanagecrm.com/api/campaigns/" + siteSetting.webKey + "/products/prices",
                    i = {
                        headers: {
                ...
                fetch(t, i).then(function(e) {
                    ...
                    try {
                        ...
                        if (i = i ? JSON.parse(i) : {
                            ...
                            var s = i.camps.filter(function(e) {
                                    return e[siteSetting.webKey]
                                }),
                                a = {};
                            s.length > 0 ? (a = s[0])[siteSetting.webKey] = t : (a[siteSetting.webKey] = t, i.camps.push(a)), localStorage.setItem(e, JSON.stringify(i))
                        }
                    } catch (e) {
                        console.log(e)
                    }
