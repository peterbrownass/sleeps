...
! function(e) {
    ...
    var r = function() {
        ...
        return n(e, null, [{
            ...
            value: function(e, t) {
                ...
                } else "afterpay" !== t.toLowerCase() && "ideal" !== t.toLowerCase() || (void 0 === e.payment.paymentProcessorId && ("afterpay" === t.toLowerCase() ? e.payment = {
                    paymentProcessorId: 39
                } : "ideal" === t.toLowerCase() && (e.payment = {
                    paymentProcessorId: 42
                })), this._isNullOrEmpty(e.customer.email) && this._logOrderErrorData("customer email field is not valid!"), this._isNullOrEmpty(e.shippingAddress.firstName) && (e.shippingAddress.firstName = e.customer.firstName), this._isNullOrEmpty(e.shippingAddress.lastName) && (e.shippingAddress.lastName = e.customer.lastName), this._isNullOrEmpty(e.shippingAddress.address1) && this._logOrderErrorData("shippingAddres address1 field is not valid!"), this._isNullOrEmpty(e.shippingAddress.city) && this._logOrderErrorData("shippingAddres city field is not valid!"), this._isNullOrEmpty(e.shippingAddress.countryCode) && this._logOrderErrorData("shippingAddres countryCode field is not valid!"), (this._isNullOrEmpty(e.shippingAddress.state) || "N/A" == e.shippingAddress.state || "-" == e.shippingAddress.state) && (e.shippingAddress.state = e.shippingAddress.countryCode));
        ...
        n = function() {
            ...
            function O(t, i, n) {
                i.constructor === t.constructor && n === A && i.constructor.resolve === E ? function(e, t) {
                    t._state === T ? M(e, t._result) : t._state === k ? B(e, t._result) : j(t, void 0, function(t) {
                        return x(e, t)
                    }, function(t) {
                        return B(e, t)
                    })
                }(t, i) : n === I ? (B(t, I.error), I.error = null) : void 0 === n ? M(t, i) : e(n) ? function(e, t, i) {
                    s(function(e) {
                        var n = !1,
                            r = function(e, t, i, n) {
                                try {
            ...
            function x(e, t) {
                var i, n;
                e === t ? B(e, new TypeError("You cannot resolve a promise with itself")) : (n = typeof(i = t), null === i || "object" !== n && "function" !== n ? M(e, t) : O(e, t, _(t)))
            }
            ...
            function B(e, t) {
                e._state === C && (e._state = k, e._result = t, s(N, e))
            }
            ...
            function U(t, i, n, r) {
                ...
                i._state !== C || (o && l ? x(i, a) : u ? B(i, s) : t === T ? M(i, a) : t === k && B(i, a))
            }
            var D = 0;
            ...
            var R = function() {
                ...
                return e.prototype._enumerate = function(e) {
                    ...
                    var n = this.promise;
                    n._state === C && (this._remaining--, e === k ? B(n, i) : this._result[t] = i), 0 === this._remaining && M(n, this._result)
            ...
            var V = function() {
                function t(e) {
                    this[P] = D++, this._result = this._state = void 0, this._subscribers = [], S !== e && ("function" != typeof e && function() {
    ...
    var d = function() {
        function e() {
            if (!x) {
                try {
                    (e = S.getElementsByTagName("body")[0].appendChild(S.createElement("span"))).parentNode.removeChild(e)
                } catch (e) {
                    return
                }
                x = !0;
        ...
        function i(e) {
            ...
            else if (void 0 !== S.addEventListener) S.addEventListener("load", e, !1);
            else if (void 0 !== P.attachEvent) ! function(e, t, i) {
        ...
        function u(e, t, i) {
            ...
            if (r)
                if (void 0 === e.id && (e.id = i), B.ie && B.win) {
                    ...
                    for (var l in (s = S.createElement("object")).setAttribute("type", "application/x-shockwave-flash"), e) e[l] != Object.prototype[l] && ("styleclass" == l.toLowerCase() ? s.setAttribute("class", e[l]) : "classid" != l.toLowerCase() && s.setAttribute(l, e[l]));
                    for (a in t) t[a] != Object.prototype[a] && "movie" != a.toLowerCase() && (e = s, o = a, l = t[a], (i = S.createElement("param")).setAttribute("name", o), i.setAttribute("value", l), e.appendChild(i));
        ...
        function p(e, t, i, n) {
            if (!B.ie || !B.mac) {
                ...
                r && (i = i && "string" == typeof i ? i : "screen", n && (E = A = null), A && E == i || ((n = S.createElement("style")).setAttribute("type", "text/css"), n.setAttribute("media", i), A = r.appendChild(n), B.ie && B.win && void 0 !== S.styleSheets && 0 < S.styleSheets.length && (A = S.styleSheets[S.styleSheets.length - 1]), E = i), B.ie && B.win ? A && "object" == typeof A.addRule && A.addRule(e, t) : A && void 0 !== S.createTextNode && A.appendChild(S.createTextNode(e + " {" + t + "}")))
            }
        }
        ...
        var v, y, b, w, A, E, P = window,
            ...
            M = !0,
            B = function() {
                var e = void 0 !== S.getElementById && void 0 !== S.getElementsByTagName && void 0 !== S.createElement,
                ...
                else if (void 0 !== P.ActiveXObject) try {
        ...
        return B.w3 && ((void 0 !== S.readyState && "complete" == S.readyState || void 0 === S.readyState && (S.getElementsByTagName("body")[0] || S.body)) && e(), x || (void 0 !== S.addEventListener && S.addEventListener("DOMContentLoaded", e, !1), B.ie && B.win && (S.attachEvent("onreadystatechange", function() {
            "complete" == S.readyState && (S.detachEvent("onreadystatechange", arguments.callee), e())
        }), P == top && function() {
            if (!x) {
                try {
            ...
            x || (/loaded|complete/.test(S.readyState) ? e() : setTimeout(arguments.callee, 0))
            ...
            expressInstallCallback: function() {
                if (N) {
                    ...
                    e && v && (e.parentNode.replaceChild(v, e), y && (m(y, !0), B.ie && B.win && (v.style.display = "block")), b && b(w)), N = !1
                }
            }
        }
    }();
